...
if(isset($_POST['turn'])){
    $user_this = $result['user_id'];
    $file = $_POST['file_name'];
    $query = mysqli_query($conn,"
        INSERT INTO `student_submission` 
        (`classroom_code`, `classwork_id`, `user_id`, `submission_file_id`, `submission_date`, `submission_file_name`, `submission_file_extension`, `marks`)
         VALUES 
         ('$class_code', '$file_id', '$user_id', '$file_id', '2022-05-24 23:18:16', '$file', '.jpg', '0');");
}
?>
...
<div class="left-container">
    <div class="ui grid">
        ...
        <div class="ui three wide column">
            <?php
            if ($_SESSION['error'] == "success submission") {
            ...
            <div class="ui card">
                ...
                <div class="extra content">
                    <form method="post" action="../../includes/process_submit_classwork.php?class_code=<?php echo $class_code; ?>" enctype="multipart/form-data">
                        ...
                        <br><br>
                        <button name="turn" class="fluid ui button">Turn in</button>
                    </form>
                </div>
            </div>
            <div class="ui card">
